...
func main() {
	...
	quarterCapacity, _ := strconv.ParseFloat(netcapacity, 64)
	quarterCapacity /= 4.0
	quarterNet := strconv.FormatFloat(quarterCapacity, 'f', -1, 64)
	...
	expCfg.AddParameter("Network", wcAttrbs, "bandwidth", quarterNet)
